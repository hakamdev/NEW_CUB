...
int						get_color_from_txt(t_cub *cub, t_wdata *stripe,
						int pos[2], int img);
...
void					render_ciel_stripe(t_cub *cub, int ystart, int yend,
						int x);
void					render_flor_stripe(t_cub *cub, int ystart, int yend,
						int x);
